...
`3.2.1` is the production release of the deterministic source-evidence replay system. It does not claim full arbitrary EVM execution or formal verification. Forge output requires compilation, regression tests and review before deployment.
