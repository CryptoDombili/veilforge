...
`3.2.2` is the production release with publisher-scoped Arc Registry V2 anchoring and deterministic source-evidence replay. It does not claim full arbitrary EVM execution or formal verification. Forge output requires compilation, regression tests and review before deployment.
