...
export function scanSummary(result, projectId, outputFiles = [], outputDirectory = null, integrations = {}) {
  ...
  return {
    ...
    incompleteReasons: [...(result.incompleteReasons ?? [])], warnings: [...(result.warnings ?? [])], errors: [...(result.errors ?? [])], ...integrations,
  };
}
