...
const INITIAL = Uint32Array.from([0x6a09e667, 0xbb67ae85, 0x3c6ef372, 0xa54ff53a, 0x510e527f, 0x9b05688c, 0x1f83d9ab, 0x5be0cd19]);
...
export function sha256Bytes(input) {
  ...
  for (let offset = 0; offset < paddedLength; offset += 64) {
    ...
    for (let index = 0; index < 64; index += 1) {
      ...
      const temporary1 = (h + sum1 + choose + ROUND[index] + words[index]) >>> 0;
...
export const hexSha256 = (input) => [...sha256Bytes(input)].map((byte) => byte.toString(16).padStart(2, '0')).join('');
